...
export const table = tv({
  slots: {
    ...
    featuresSearchButton:
      "p-2 h-full aspect-square bg-blue-600 hover:bg-blue-500 cursor-pointer flex items-center justify-center rounded-xl shadow",
    featuresButton:
      "bg-blue-600 hover:bg-blue-500 px-4 py-2 flex items-center justify-center gap-3 rounded-xl shadow text-white font-medium capitalize",
