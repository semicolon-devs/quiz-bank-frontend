...
export const InfoIcon = (props: { classes: string }) => (
  <svg
    className={props.classes}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const MinusIcon = (props: { classes: string }) => (
  <svg
    className={props.classes}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const PlusIcon = (props: { classes: string }) => (
  <svg
    className={props.classes}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const GradesIcon = (props: { classes: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
